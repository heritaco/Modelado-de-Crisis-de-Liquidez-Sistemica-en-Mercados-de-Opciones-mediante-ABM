...
% --- Make the "List of Figures" title huge and nicely styled ---
\renewcommand{\cftloftitlefont}{%
  \centering
  \garamondbold\huge
}
\renewcommand{\cftafterloftitle}{\par\vspace{1.5em}} % space below the title
...
\vspace*{-60pt}
\listoffigures
\thispagestyle{firstpagee} % No header/footer on LOF page
\newpage
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.26\textwidth]{estado actual.png}
...
El espacio de fases deja ver que la crisis no es sólo una caída de precio puntual, sino una transición de régimen: el sistema sale de una región $(S,\sigma)$ de baja volatilidad y pasa a otra región caracterizada por precios deprimidos y volatilidad persistentemente elevada.

\begin{figure}[H]
    \centering
    \includegraphics[width=0.75\textwidth]{phase space analysis.png}
    \caption{Trayectoria en el espacio de fases $(S_t, \sigma_{\text{imp},t})$. El sistema parte de un estado de baja volatilidad y precio estable, sufre un shock que desplaza ambos valores, y evoluciona hacia un régimen de precios bajos y alta volatilidad.}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.75\textwidth]{liquidation cascades.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.85\textwidth]{statistical distributions.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.85\textwidth]{spectral analysis.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.85\textwidth]{contagion n systimic risk.png}
