...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.45\textwidth]{estado actual.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{phase space analysis.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.85\textwidth]{liquidation cascades.png}
